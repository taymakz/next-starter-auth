...
export default function AuthLayout({ children }: PropType) {
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center overflow-hidden bg-background bg-dot-white/5">
      ...
      <div className="container relative z-10">
        <Card className={cn("relative mx-auto max-w-[400px] py-4")}>
