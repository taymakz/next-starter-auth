...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 px-6 pt-6 text-center sm:text-start",
      className,
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse border-t bg-secondary px-6 py-3 sm:flex-row sm:justify-end sm:gap-x-2 sm:rounded-b-lg",
      className,
    )}
    {...props}
  />
